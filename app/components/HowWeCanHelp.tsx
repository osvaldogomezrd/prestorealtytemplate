...
const situations = [
  {
    ...
    description: "Stop foreclosure in its tracks. We can close fast enough to help you avoid losing your home.",
  },
  {
    icon: Landmark,
    title: "Tax Liens",
    description: "Dealing with back taxes or liens? We buy homes with liens and handle the complications.",
  },
  {
    icon: Briefcase,
    title: "Inherited Property",
    description: "Inherited a property you don't want to manage? We make the process simple and fast.",
  },
  {
    icon: Wrench,
    title: "Major Repairs Needed",
    description: "Don't spend thousands on repairs. We buy homes as-is, no matter the condition.",
  },
  {
    icon: Heart,
    title: "Divorce",
    description: "Need to sell quickly due to a divorce? We provide a clean, fast solution.",
  },
  {
    icon: ArrowRightLeft,
    title: "Relocating",
    description: "Moving out of state or country? We can close on your schedule so you can move on.",
  },
  {
    icon: Users,
  ...
  },
  {
    icon: Clock,
    title: "Probate",
    description: "Going through probate? We have experience buying homes in probate situations.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            No matter your situation, we have helped hundreds of Las Vegas homeowners just like you.
          </p>
        </div>
